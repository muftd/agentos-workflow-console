        ...
        <div className="flex items-center gap-6 md:gap-8 min-w-max pb-4">
          ...
          {onAddStep && (
            <>
              ...
              <Button
                variant="outline"
                className="w-80 h-48 border-2 border-dashed border-blue-600/40 dark:border-blue-400/40 bg-blue-600/5 dark:bg-blue-400/5 hover:bg-blue-600/10 dark:hover:bg-blue-400/10 hover:border-blue-600/60 dark:hover:border-blue-400/60 transition-all duration-300"
                onClick={onAddStep}
              >
                <div className="flex flex-col items-center gap-3">
                  <Plus className="w-10 h-10 text-blue-600 dark:text-blue-400" />
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Add New Step</span>
                </div>
              </Button>
            </>
          )}
